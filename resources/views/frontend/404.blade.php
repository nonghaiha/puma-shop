                                    ...
                                    <tr class="product-row">
                                        <td class="product-col">
                                            ...
                                            <h2 class="product-title">
                                                <a href="product.html">{{$ite['name']}}</a>
                                            </h2>
                                        </td>
                                        <td>{{number_format($ite['price'])}} VNĐ</td>
                                        <td> 
                                            <input class="vertical-quantity form-control" type="text" value="{{$ite['quantity']}}" name="quantity[]">
                                        </td>
                                        <td>{{number_format($ite['price']*$ite['quantity'])}}</td>
                                    </tr>
                                </tbody>
								@endforeach
                                <tfoot>
                                    <tr>
                                        <td colspan="4" class="clearfix">
                                            <div class="float-left">
                                                <a href="{{route('product.all')}}" class="btn btn-outline-secondary">Continue Shopping</a>
                                            </div><!-- End .float-left -->
