                                ...
                                <tr class="product-row">
                                    ...
                                    <td>
                                        <form action="{{route('cart.update',['id'=>$model['id']])}}">
                                            <input name="quantity" class="vertical-quantity form-control" type="text"
                                                   value="{{$model['quantity']}}">
                                            <button type="submit">Update</button>
                                        </form>
                                    </td>
                                    <td>{{number_format($model['quantity']*$model['price'])}} $</td>
                                </tr>
                                <tr class="product-action-row">
                                    <td colspan="4" class="clearfix">
                                        <div class="float-right">
                                            <a href="{{route('cart.remove',['id'=>$model['id']])}}"
                            ...
                            <tr>
                                <td colspan="4" class="clearfix">
                                    <div class="float-left">
                                        <a href="{{route('frontend.layout')}}" class="btn btn-outline-secondary">Continue
                                            Shopping</a>
                                    </div><!-- End .float-left -->
                                    <div class="float-right">
                    ...
                    <div class="cart-summary">
                        ...
                        <h4>
                            <a data-toggle="collapse" href="#total-estimate-section" class="collapsed" role="button"
                               aria-expanded="false" aria-controls="total-estimate-section">Estimate Shipping and
                                Tax</a>
                        </h4>
                        ...
                        <table class="table table-totals">
                            ...
                            <tr>
                                <td>Subtotal</td>
                                <td>{{number_format($carts->total_price)}} $</td>
                            </tr>
                        ...
                        <div class="checkout-methods">
                            <a href="{{route('checkout')}}" class="btn btn-block btn-sm btn-primary" id="cartCheck">Go to Checkout</a>
