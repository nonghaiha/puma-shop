            <div class="home-slider-container">
                <div class="home-slider owl-carousel owl-theme owl-theme-light">
                    <div class="home-slide">
                        <div class="slide-bg owl-lazy"  data-src="{{ url('/frontend') }}/assets/images/slider/surfing-3.jpg" style="width: 1920px"></div><!-- End .slide-bg -->
                        <div class="container">
                    ...
                    <div class="home-slide">
                        <div class="slide-bg owl-lazy"  data-src="{{ url('/frontend') }}/assets/images/slider/yoga-4.jpg"></div><!-- End .slide-bg -->
                        <div class="container">
                            <div class="row">
